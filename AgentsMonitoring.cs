...
";
    ...
    class JSformatter {
        ...
        public string GetAgentTableName(string agent_name) {
            switch (agent_name) {
                ...
                case "Software Management Solution Agent":
                    return "swm_table";
				case "Altiris Application Metering Agent":
					return "am_table";
				case "Symantec Workspace Virtualization Agent":
					return "svs_table";
            }
            return "unk";
        }
        public string ConvertGauges(string gauge) {
			...
			b.Replace("Symantec Workspace Virtualization Agent", "SVS");
			b.Replace("Altiris Application Metering Agent", "AppMet");
            return b.ToString();
        }
    }
}
